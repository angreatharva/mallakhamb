...
function AppContent() {
  ...
  // Check if current route is admin dashboard, teams, or scoring
  ...
  return (
    <AuthContext.Provider value={{ user, userType, login, logout: handleLogout }}>
      <div className="min-h-screen bg-gray-50">
        {/* Only show main navbar if not on admin dashboard */}
        {!isAdminDashboard && <Navbar user={user} userType={userType} onLogout={handleLogout} />}
