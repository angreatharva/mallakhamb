...
const JudgeScoring = () => {
  ...
  const fetchJudges = async () => {
    try {
      ...
      const activeJudges = response.data.judges.filter(judge => judge.name && judge.name.trim() !== '');
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-lg">Judge Scoring</span>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-2xl text-center border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
                  placeholder="0.0"
                />
              </div>
