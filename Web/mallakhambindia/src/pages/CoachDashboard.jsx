    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need to create a team first.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                disabled={!team?.players || team.players.length === 0}
              >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{team.players?.length || 0}</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Boys Age Groups</h2>
          ...
          {/* Girls Age Groups */}
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Girls Age Groups</h2>
            <div className="space-y-4">
        ...
        {showTeamSummary && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-4xl w-full mx-4 max-h-[80vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Team Summary - {team.name}</h3>
                <button
                        ...
                        {['U10', 'U12', 'U14', 'U18', 'Above18'].map(ageGroup => {
                          ...
                          return (
                            <div key={ageGroup} className="border border-gray-200 rounded-lg p-3">
                              <div className="flex justify-between items-center mb-2">
                                <span className="font-medium">{getAgeGroupDisplay(ageGroup)}</span>
                                <span className="text-sm text-gray-600">{players.length} players</span>
                              </div>
                              {players.length > 0 ? (
        ...
        {showAddPlayer && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-4 relative">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Add Player to Age Group</h3>
                      ...
                      {players.map((player, index) => (
                        ...
                        >
                          ...
                          <div className="text-sm text-gray-500">
                            {player.aadharNumber} • {player.gender} •
                            {player.dateOfBirth ? ` Age: ${calculateAge(player.dateOfBirth)}` : ' Age: Unknown'}
                          </div>
                        </button>
                      ))}
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="bg-gray-50 p-3 rounded-md space-y-1">
                        <div className="font-medium">{selectedPlayer.label}</div>
