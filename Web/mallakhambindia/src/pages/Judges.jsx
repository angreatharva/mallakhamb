  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl shadow-lg p-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Judge Management</h2>
              ...
              <div>
                <div className="mb-4 p-4 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-xs text-blue-600">
                    • All 5 judge slots will be created (minimum 1 judge required, maximum 5 judges allowed)
                  </p>
                  <p className="text-xs text-blue-600">
                    • Empty slots can be filled later using the "Judge List" feature
                  </p>
                  <p className="text-xs text-blue-600">
                    • Usernames are auto-generated but can be edited
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-white rounded-md text-sm ${editFormData.name.trim()
