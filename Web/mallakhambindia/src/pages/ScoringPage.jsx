                    ...
                    <tr key={player.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">
                        <input
                          ...
                          min="0"
                          max="10"
                          value={scores[player.id]?.seniorJudge || ''}
                          onChange={(e) => handleScoreChange(player.id, 'seniorJudge', e.target.value)}
                          className="w-20 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
                          placeholder="0.0"
                        />
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        <input
                          ...
                          min="0"
                          max="10"
                          value={scores[player.id]?.judge1 || ''}
                          onChange={(e) => handleScoreChange(player.id, 'judge1', e.target.value)}
                          className="w-20 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
                          placeholder="0.0"
                        />
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        <input
                          ...
                          min="0"
                          max="10"
                          value={scores[player.id]?.judge2 || ''}
                          onChange={(e) => handleScoreChange(player.id, 'judge2', e.target.value)}
                          className="w-20 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
                          placeholder="0.0"
                        />
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        <input
                          ...
                          min="0"
                          max="10"
                          value={scores[player.id]?.judge3 || ''}
                          onChange={(e) => handleScoreChange(player.id, 'judge3', e.target.value)}
                          className="w-20 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
                          placeholder="0.0"
                        />
                      </td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        <input
                          ...
                          min="0"
                          max="10"
                          value={scores[player.id]?.judge4 || ''}
                          onChange={(e) => handleScoreChange(player.id, 'judge4', e.target.value)}
                          className="w-20 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-purple-500"
                          placeholder="0.0"
                        />
                      </td>
                        ...
                        <div className="text-xs text-gray-500 mt-1 text-center">
                          {(() => {
                            ...
                            if (judgeScores.length <= 3) {
                              ...
                              return `Excl: ${sorted[0]}, ${sorted[sorted.length - 1]}`;
                            }
                          })()}
                        </div>
                      </td>
