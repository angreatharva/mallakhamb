...
describe('DesignTokenAudit', () => {
  ...
  it('switches to spacing section when spacing tab is clicked', () => {
    render(<DesignTokenAudit />);
  ...
  it('switches to other tokens section when other tab is clicked', () => {
    render(<DesignTokenAudit />);
  ...
  it('documents intended use cases for all color categories', () => {
    ...
    expect(screen.getByText(/Primary brand colors used throughout the application/i)).toBeInTheDocument();
