...
describe('ThemedSelect', () => {
  ...
  it('should render with placeholder', () => {
    renderWithTheme(<ThemedSelect options={mockOptions} placeholder="Select an option" />);
  ...
  it('should render with different role themes', () => {
    ...
    roles.forEach((role) => {
      const { unmount, container } = renderWithTheme(<ThemedSelect options={mockOptions} />, role);
