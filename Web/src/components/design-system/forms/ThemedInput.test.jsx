...
describe('ThemedInput', () => {
  ...
  it('should render with icon when provided', () => {
    const { container } = renderWithTheme(<ThemedInput icon={Mail} placeholder="Email" />);
  ...
  it('should display error message when error is a string', () => {
    renderWithTheme(<ThemedInput error="This field is required" placeholder="Email" />);
  ...
  it('should not display error message when error is boolean true', () => {
    renderWithTheme(<ThemedInput error={true} placeholder="Email" />);
  ...
  it('should render rightElement when provided', () => {
    const { container } = renderWithTheme(
      <ThemedInput placeholder="Password" rightElement={<button>Toggle</button>} />
    );
