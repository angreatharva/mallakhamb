...
describe('ThemedButton', () => {
  ...
  it('should render outline variant', () => {
    const { container } = renderWithTheme(
      <ThemedButton variant="outline">Submit</ThemedButton>
    );
    const button = screen.getByRole('button');
  ...
  it('should render ghost variant', () => {
    renderWithTheme(
      <ThemedButton variant="ghost">Submit</ThemedButton>
    );
    const button = screen.getByRole('button');
  ...
  it('should render all size variants', () => {
    ...
    sizes.forEach(size => {
      const { unmount } = renderWithTheme(
        <ThemedButton size={size}>{size} button</ThemedButton>
      );
  ...
  it('should accept custom className', () => {
    renderWithTheme(
      <ThemedButton className="custom-class">Submit</ThemedButton>
    );
    const button = screen.getByRole('button');
