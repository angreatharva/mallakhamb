...
export const ThemedTextarea = forwardRef(
  ({ error, className, disabled, readOnly, rows = 4, ...props }, ref) => {
      ...
      <div className="w-full">
        ...
        <motion.textarea
          ...
          className={clsx(
            ...
            // Disabled state
            disabled && ['opacity-50', 'cursor-not-allowed', 'border-white/5', 'resize-none'],

            // Readonly state
            readOnly && ['cursor-default', 'border-white/5', 'resize-none'],
