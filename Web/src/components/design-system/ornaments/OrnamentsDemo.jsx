  ...
  return (
    ...
    >
      ...
      <section style={{ marginBottom: '4rem' }}>
        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>ShieldOrnament (Admin/Judge)</h2>
        <div
          style={{
            display: 'flex',
            gap: '3rem',
      ...
      <section style={{ marginBottom: '4rem' }}>
        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>CoachOrnament</h2>
        <div
          style={{
            display: 'flex',
            gap: '3rem',
      ...
      <section style={{ marginBottom: '4rem' }}>
        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>GradientText</h2>
        <div
          style={{
            display: 'flex',
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <p
              style={{ marginTop: '0.5rem', fontSize: '0.875rem', color: 'rgba(255,255,255,0.5)' }}
            >
              Uses theme colors
            </p>
          </div>
      ...
      <section style={{ marginBottom: '4rem' }}>
        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>Theme Integration</h2>
        <div
          style={{
            display: 'flex',
            gap: '2rem',
      ...
      {/* Usage Examples */}
      <section>
        <h2 style={{ marginBottom: '2rem', textAlign: 'center' }}>Usage Examples</h2>
        <div
          style={{
            maxWidth: '800px',
            margin: '0 auto',
