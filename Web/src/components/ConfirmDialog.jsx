...
const ConfirmDialog = ({
  ...
  const accentColor =
    variant === 'danger' ? '#EF4444' : variant === 'success' ? '#22C55E' : COLORS.saffron;

  const IconComp =
    variant === 'danger' ? Trash2 : variant === 'success' ? CheckCircle : AlertTriangle;
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div
              className="px-6 pb-4"
              style={{ padding: isMobile ? '0 1rem 0.75rem' : '0 1.5rem 1rem' }}
            >
              <p
