...
const InfoRow = ({ label, value, last = false }) => (
  <div
    className={`flex flex-col sm:flex-row sm:items-center sm:justify-between py-3 gap-1 ${!last ? 'border-b' : ''}`}
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-8 space-y-8 pt-24">
        ...
        <FadeIn>
          ...
          >
            <div
              ...
              style={{
                background: `radial-gradient(ellipse at 0% 50%, ${COLORS.saffron}08, transparent 60%)`,
              }}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            delay={0.06}
            value={
              player?.ageGroup ? AGE_GROUP_MAP[player.ageGroup] || player.ageGroup : 'Not assigned'
            }
          />
              ...
              {player?.team ? (
                <>
                  ...
                  <InfoRow
                    ...
                    value={
                      player.ageGroup
                        ? AGE_GROUP_MAP[player.ageGroup] || player.ageGroup
                        : 'Not assigned'
                    }
                  />
                ...
                <div className="py-6 text-center">
                  ...
                  <p className="text-white/25 text-xs mb-5">
                    Select a team from the card above to join.
                  </p>
