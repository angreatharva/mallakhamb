...
import {
  ...
  EASE_OUT as DESIGN_EASE_OUT,
  EASE_SPRING as DESIGN_EASE_SPRING,
} from '../../styles/tokens';
...
export const SaffronButton = ({ children, to, className = '', variant = 'solid', ...props }) => {
  const base =
    'inline-flex items-center justify-center gap-2 rounded-full font-bold text-sm transition-all duration-200 min-h-[44px] px-6 cursor-pointer';
...
export const roles = [
  {
    icon: Users,
    title: 'Player',
    loginTo: '/player/login',
    registerTo: '/player/register',
    color: COLORS.saffron,
    desc: 'Register, join a team, and compete.',
  },
  {
    icon: UserCheck,
    title: 'Team Coach',
    loginTo: '/coach/login',
    registerTo: '/coach/register',
    color: '#22C55E',
    desc: 'Manage your team and handle payments.',
  },
  {
    icon: Shield,
    title: 'Judge',
    ...
    registerTo: null,
    color: '#A855F7',
    desc: 'Score performances and manage results.',
  },
  {
    icon: Award,
    title: 'Admin',
    ...
    registerTo: null,
    color: '#EF4444',
    desc: 'Oversee competition operations.',
  },
];
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 2 }}>
      ...
      <motion.div
        ...
        style={{
          background: `linear-gradient(to bottom, transparent, ${COLORS.saffron}, transparent)`,
        }}
        animate={{ left: ['0%', '100%'] }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between h-16 md:h-20">
        <Link
          ...
          aria-label="Bhausaheb Ranade Mallakhamb Home"
        >
          <motion.img
            src={BHALogo}
            alt="BHA Logo"
...
const HeroSection = () => {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-dvh overflow-hidden flex items-center justify-center"
      aria-label="Hero"
    >
      {/* Parallax BG */}
      <motion.div className="absolute inset-0 z-0" style={{ y: bgY, scale: bgScale }}>
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(to bottom, rgba(10,10,10,0.72) 0%, rgba(10,10,10,0.15) 40%, rgba(10,10,10,0.95) 100%)',
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background: `radial-gradient(ellipse at center, transparent 20%, rgba(10,10,10,0.65) 100%)`,
          }}
        />
      </motion.div>
      ...
      >
        ...
        <motion.p
          className="text-white/70 text-lg sm:text-xl md:text-2xl font-light tracking-widest uppercase mb-3"
        ...
        <motion.p
          className="text-white/45 text-sm sm:text-base max-w-xl mx-auto mb-10 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.7, delay: 0.8 }}
        >
          The ultimate platform for traditional Indian gymnastics where strength meets grace on the
          pole.
        </motion.p>
        ...
        >
          <p className="text-white/35 text-xs tracking-widest uppercase mb-4">
            ...
            {roles.map((role, i) => {
              ...
              return (
                ...
                >
                  <TiltCard>
                    <div
                      className="p-4 rounded-2xl border flex flex-col gap-3 text-left h-full"
                      style={{
...
const StatsBar = () => (
  <section
    className="relative z-10 py-10 border-y"
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <FadeIn direction="right" className="relative order-2 lg:order-1">
          ...
          >
            <img
              src={TextRevealBg}
              alt="Mallakhamb athlete performing on pole"
            ...
            />
            <motion.div
              className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl border"
              style={{
          ...
          <div
            className="absolute -top-4 -left-4 w-24 h-24 rounded-2xl border-t-2 border-l-2 pointer-events-none"
            style={{ borderColor: COLORS.saffron }}
          />
          <div
            className="absolute -bottom-4 -right-4 w-24 h-24 rounded-2xl border-b-2 border-r-2 pointer-events-none"
            style={{ borderColor: COLORS.saffron }}
          />
        </FadeIn>
        ...
        <FadeIn direction="left" delay={0.2} className="order-1 lg:order-2 space-y-8">
          ...
          <p className="text-white/55 text-lg leading-relaxed">
            ...
            gymnast performs aerial yoga or gymnastic postures and wrestling grips in concert with a
            vertical stationary or hanging wooden pole, cane, or rope.
          </p>
          <p className="text-white/40 leading-relaxed">
            The Bhausaheb Ranade Navodit Mallakhamb Competition has been a cornerstone of this
            tradition since 1984, producing national champions and preserving this ancient art form
...
const timelineEvents = [
  {
    year: '1984',
    title: 'Founded',
    desc: 'Bhausaheb Ranade Navodit Mallakhamb Competition established in Mumbai.',
  },
  {
    year: '1990s',
    title: 'National Recognition',
    desc: 'Competition gains national prominence, attracting athletes from across India.',
  },
  {
    year: '2000s',
    title: 'Champions Emerge',
    desc: "Over 50 national champions produced, cementing the event's legacy.",
  },
  {
    year: '2020s',
    title: 'Digital Era',
    desc: 'Platform modernized with live scoring, digital registration, and real-time results.',
  },
];
...
const LegacyTimeline = () => (
  <section
    ...
    style={{ background: COLORS.darkElevated }}
    aria-label="Competition history timeline"
  >
    <div
      className="absolute inset-0 pointer-events-none"
      style={{
        background: `radial-gradient(ellipse at 80% 50%, ${COLORS.saffron}06, transparent 60%)`,
      }}
    />
    <div className="max-w-5xl mx-auto px-4 md:px-8">
      <FadeIn className="text-center mb-16">
        ...
        <h2 className="text-4xl md:text-5xl font-black text-white">
          A Living <GradientText>Legacy</GradientText>
        </h2>
      </FadeIn>
      <div className="relative">
        <div
          className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px -translate-x-1/2 pointer-events-none"
          style={{
            background: `linear-gradient(to bottom, transparent, ${COLORS.saffron}50, transparent)`,
          }}
        />
        <div className="space-y-12">
          {timelineEvents.map((ev, i) => (
            <FadeIn key={ev.year} delay={i * 0.1} direction={i % 2 === 0 ? 'right' : 'left'}>
              ...
              >
                <div
                  className={`flex-1 pl-12 md:pl-0 ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}
                >
                  <div
                    className="inline-block p-5 rounded-2xl border"
...
const QuoteStrip = () => (
  ...
  >
    <div
      className="absolute inset-0 pointer-events-none"
      style={{
        background: `radial-gradient(ellipse at 50% 50%, ${COLORS.saffron}06, transparent 70%)`,
      }}
    />
    <FadeIn className="max-w-4xl mx-auto px-4 text-center relative z-10">
      <Quote
        className="w-8 h-8 mx-auto mb-6 opacity-30"
        style={{ color: COLORS.saffron }}
        aria-hidden="true"
      />
      <blockquote>
        <p className="text-2xl md:text-3xl font-black text-white leading-snug mb-6">
          "Mallakhamb is not just a sport it is a <GradientText>living meditation</GradientText> of
          strength, balance, and the ancient spirit of India."
        </p>
        <footer className="text-white/35 text-sm font-medium tracking-wide">
          {' '}
          Bhausaheb Ranade, Founder
        </footer>
      </blockquote>
    </FadeIn>
  </section>
...
const features = [
  {
    ...
    title: 'Live Scoring',
    description:
      'Real-time score updates as performances happen on the mat. Every point, every moment  live.',
    href: '/scores',
    hero: true,
  ...
  },
  {
    ...
    description: 'Coaches manage rosters, assign roles, and track performance.',
    href: '/coach/login',
    accent: '#22C55E',
  },
  {
    icon: Camera,
    title: 'Event Gallery',
    description: 'Capture and relive the best moments from every competition.',
    href: '/gallery',
    accent: '#A855F7',
  },
  {
    ...
    description: 'Stay updated with the latest event schedule and competition rules.',
    href: '/schedule',
    accent: '#3B82F6',
  },
  {
    ...
    description: 'Rankings update in real-time as judges submit scores.',
    href: '/scores',
    accent: COLORS.gold,
  },
];
...
const FeatureCard = ({ feature, index }) => {
  ...
  return (
    <FadeIn
      delay={index * 0.07}
      className={feature.hero ? 'sm:col-span-2 lg:col-span-2 sm:row-span-2' : ''}
    >
      <Link to={feature.href} className="group block h-full">
        <motion.div
          ...
          style={{
            background: feature.hero
              ? `linear-gradient(135deg, ${feature.accent}12, ${COLORS.darkCard})`
              : COLORS.darkCard,
          ...
          whileHover={{
            ...
            boxShadow: `0 0 50px ${feature.accent}15`,
            y: -4,
          }}
        ...
        >
          <motion.div
            ...
            style={{
              background: `radial-gradient(ellipse at 20% 20%, ${feature.accent}10, transparent 60%)`,
            }}
          />
          <div
            className={`rounded-xl flex items-center justify-center relative z-10 ${feature.hero ? 'w-14 h-14' : 'w-10 h-10'}`}
            style={{ background: `${feature.accent}18` }}
          >
            <Icon
              className={feature.hero ? 'w-7 h-7' : 'w-5 h-5'}
              style={{ color: feature.accent }}
              aria-hidden="true"
            />
          </div>
          <div className="relative z-10 flex-1">
            <h3 className={`text-white font-bold ${feature.hero ? 'text-2xl' : 'text-lg'}`}>
              {feature.title}
            </h3>
            <p
              className={`text-white/45 mt-1 leading-relaxed ${feature.hero ? 'text-base' : 'text-sm'}`}
            >
              {feature.description}
            </p>
          </div>
          <div
            className="mt-auto flex items-center gap-2 text-xs font-semibold relative z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-200"
            style={{ color: feature.accent }}
          >
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="lg:col-span-2 space-y-4">
          ...
          <p className="text-white/35 text-sm leading-relaxed max-w-sm">
            A Sports Event started in 1984, producing award-winning national players and preserving
            the tradition of Mallakhamb.
          </p>
            ...
            <ul className="space-y-3">
              {links.map((link) => (
                <li key={link.to}>
                  ...
                  >
                    <span
                      className="w-1 h-1 rounded-full group-hover:w-3 transition-all duration-200"
                      style={{ background: COLORS.saffron }}
                    />
                    {link.label}
                  </Link>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-white/35 text-sm leading-relaxed">
                Sane Guruji Vidya Mandir, Santacruz(E), Mumbai.
              </p>
            </div>
            <a
