...
const SuperAdminSystemStats = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <FadeIn>
        <div className="flex items-center justify-between">
          ...
          <motion.button
            ...
            style={{
              background: `${ADMIN_COLORS.saffron}18`,
              color: ADMIN_COLORS.saffronLight,
              border: `1px solid ${ADMIN_COLORS.saffron}30`,
            }}
      ...
      <FadeIn delay={0.05}>
        <DarkCard className="p-6">
          <SectionHeader
            ...
            title="System Health"
            color={dbOk ? ADMIN_COLORS.green : ADMIN_COLORS.red}
          />
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div
              className="flex items-center gap-4 p-4 rounded-xl border"
              style={{
                background: `${dbOk ? ADMIN_COLORS.green : ADMIN_COLORS.red}08`,
                borderColor: `${dbOk ? ADMIN_COLORS.green : ADMIN_COLORS.red}25`,
              }}
            >
              <HealthDot ok={dbOk} />
              <div>
                <p
                  ...
                  style={{ color: dbOk ? ADMIN_COLORS.green : ADMIN_COLORS.red }}
                >
                  Database
                </p>
            ...
            <div
              className="flex items-center gap-4 p-4 rounded-xl border"
              style={{
                background: `${ADMIN_COLORS.green}08`,
                borderColor: `${ADMIN_COLORS.green}25`,
              }}
            >
              <HealthDot ok={true} />
              <div>
        ...
        <FadeIn delay={0.1}>
          <div className="flex items-center gap-2 mb-4">
            <div
              ...
              style={{
                background: `linear-gradient(to bottom, ${ADMIN_COLORS.saffron}, ${ADMIN_COLORS.gold})`,
              }}
            />
            <p
              className="text-xs font-bold tracking-widest uppercase"
      ...
      <div>
        <FadeIn delay={0.2}>
          <div className="flex items-center gap-2 mb-4">
            <div
              className="w-1 h-5 rounded-full"
              style={{
                background: `linear-gradient(to bottom, ${ADMIN_COLORS.purple}, ${ADMIN_COLORS.purpleLight})`,
              }}
            />
            <p
              className="text-xs font-bold tracking-widest uppercase"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <StatCard
            icon={TrendingUp}
            label="Competitions"
            value={content.totalCompetitions}
      ...
      {s &&
        Object.keys(s).filter((k) => !['users', 'content', 'system'].includes(k)).length > 0 && (
          <FadeIn delay={0.4}>
            <DarkCard className="p-6">
              <SectionHeader
                icon={Database}
              ...
              <pre className="text-xs text-white/40 overflow-x-auto leading-relaxed">
                {JSON.stringify(
                  Object.fromEntries(
                    Object.entries(s).filter(([k]) => !['users', 'content', 'system'].includes(k))
                  ),
                  null,
                  2
                )}
